# SCSM Global Patent Certification

## Sovereignty & Control Notice
...
SCSM-Global-Patent-Certification/
├── README.md
├── patent-documents/           # Patent application documents and specifications
│   ├── A.SCSM Authorized Use Statement.md
│   ├── Application Documents_CNIPA.pdf
│   ├── Application Documents_PCT.pdf
│   ├── Application Documents_USPTO.PDF
│   ├── Claims_CN.pdf
│   ├── Claims_US.pdf
│   ├── Patent Specification_CN.pdf
│   ├── Patent Specification_US.pdf
│   ├── SCSM (2).drawio
│   ├── SCSM-Technical White Paper_v1.0_20250619.pdf
│   └── investigation-layer.md
└── structured-reports/         # Security investigation structured reports
    ├── Behavior_Analysis_Report.md
    ├── simulated-report-v2-full.json
    └── simulated-security-investigation-report.pdf
```
...
| v1.0.0 | 2025-08-01 | Initial release with patent documentation |
